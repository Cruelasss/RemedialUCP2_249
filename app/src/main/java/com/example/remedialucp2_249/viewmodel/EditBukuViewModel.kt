...
import com.example.remedialucp2_249.view.route.DestinasiEditBuku
...
fun com.example.remedialucp2_249.room.Buku.Buku.toUiStateBuku(isEntryValid: Boolean): BukuUIState = BukuUIState(
